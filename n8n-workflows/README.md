...
## Chạy trên Railway (cloud) — xem DEPLOY.md
Khi deploy cloud, đổi mọi URL `http://localhost:8787` trong node HTTP thành URL agent-service trên Railway.
WF-Morning publish dashboard qua `POST /publish-dashboard` (đẩy GitHub Pages bằng API, không cần git local).
